...
<div class="cv-download-links" style="margin-bottom: 1rem;">
  <a href="{{ '/files/Boda_Resume_0526.pdf' | relative_url }}" class="btn btn--primary">Download CV as PDF</a>
</div>
...
<div style="width: 100%; height: 1100px; border: 1px solid #eee; border-radius: 8px; overflow: hidden;">
  <iframe
    src="{{ '/files/Boda_Resume_0526.pdf' | relative_url }}"
    width="100%"
    height="1100"
    style="border:0;">
  </iframe>
...
Education
======
* M.S. in Mechanical Engineering, Carnegie Mellon University, 2026
  * GPA: 3.84/4.00
